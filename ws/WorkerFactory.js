 ...
 * @Description: 
 * @FilePath: /gl_tape/ws/WorkerFactory.js
 * @LastEditTime: 2026-04-08 15:30:11
...
import SqlWorker from './workers/SqlWorker'
import LiveLogWorker from './workers/LiveLogWorker'
import FileExplorerWorker from './workers/FileExplorerWorker'
...
const Workers = {
  ...
  [Command.ExecuteSql]: SqlWorker,
  [Command.LiveLog]: LiveLogWorker,
  [Command.FileExplorer]: FileExplorerWorker,
  [Command.UploadFile]: UploadFileWorker
}
export default {
